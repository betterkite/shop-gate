#!/usr/bin/env python3
"""Validate Shop Gate's normalized market-bars contract."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate normalized Shop Gate market bars and emit JSON.")
