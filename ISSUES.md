...
| ISSUE-P28 | 电商经营分析能力扩展 | P17 | 用户漏斗与留存、RFM、渠道/活动归因、毛利/利润、补货预测、商品生命周期和价格弹性形成可运行能力；每项能力有数据缺口提示、看板模板、后端聚合、E2E case 和桌面/移动验收 | in-progress（首个后端切片已完成 RFM、渠道/活动、毛利和库存健康 5 个接口；所有结果带合成限制说明；商品生命周期、价格弹性、前端 BI 看板和 Agent 多轮下钻尚未完成；证据见 [`docs/review/p28-analytics-capabilities.md`](docs/review/p28-analytics-capabilities.md)） |
