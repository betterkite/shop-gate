...
| 想建立全局认识 | [架构总览](architecture.md) |
| 想快速跑起来 | [基础设施配置](infrastructure.md) |
...
| 想理解生成链路 | [生成工作空间契约](generated-workspace-contract.md) |
...
| 想理解零售数据和商品运营 | [零售数据接入](commerce-data-ingestion.md) |
| 想优化生成页面 | [Skills 治理规范](skills-governance.md) |
| 想做评测和运维 | [评测指南](evals-guide.md) / [运行手册](operations-runbook.md) |
...
| 想做经营日报 | [API 总览](api-reference.md) / [架构总览](architecture.md) |
| 想参与开发 | [项目结构](project-structure.md) / [运行手册](operations-runbook.md) |
| 想学习怎么写 Skills | [Skills 治理规范](skills-governance.md) |
...
| 你现在要做什么 | 先读 | 然后读 |
| --- | --- | --- |
| 只想把项目跑起来 | [配置指南](configuration.md)、[基础设施配置](infrastructure.md) | [故障排查](troubleshooting.md) |
| 第一次接手项目 | [架构总览](architecture.md) | [项目结构](project-structure.md)、[内部组件](internal-components.md) |
...
| 处理生成页面质量 | [生成工作空间契约](generated-workspace-contract.md) | [Skills 治理规范](skills-governance.md) |
| 做零售数据与商品运营 | [零售数据接入](commerce-data-ingestion.md) | [API 总览](api-reference.md)、[数据字典](data-dictionary.md) |
...
| 做评测与发布 | [评测指南](evals-guide.md) | [生产发布](release-runbook.md) |
| 写或改 Skill | [Skills 治理](skills-governance.md) | [项目结构](project-structure.md) |
...
| Skills | [Skills 治理规范](skills-governance.md) | skill 元数据、版本、发布、回滚、锁文件和编写方法 |
...
- 改启动脚本、端口池、缓存策略或 bundler 相关依赖时，至少同步 README、`infrastructure.md`、`operations-runbook.md` 和 `troubleshooting.md`。
- 页面截图只保留在本地评审产物目录，不把运行截图重新加入项目文档。
