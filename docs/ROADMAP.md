...
| 生成脚手架 | `scaffold.ts`、`retail-scaffold-templates.ts`、`scaffold-runtime-scripts.ts` | 保留零售漏斗、商品结构、价格库存、经营日报模板，并加入真实 Next build 门禁 | 继续拆 workspace writer、dependency planner、repair adapter |
