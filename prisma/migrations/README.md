# Shop Gate Prisma migration adoption
...
baseline SQL manually against a database that already contains Shop Gate data.
...
revision `c641c00`, with the regular Shop Gate tables present and none of the
