...
MARKET_ENVIRONMENT_KEYS = {
    ...
    "SHOPGATE_ANNOUNCEMENT_CACHE_TTL_SECONDS",
    "SHOPGATE_CLICKHOUSE_ENABLED",
    "SHOPGATE_DATABASE_ENABLED",
    "SHOPGATE_DATABASE_REQUIRED",
    "SHOPGATE_DEGRADATION_MODE",
    "SHOPGATE_FINANCIAL_CACHE_TTL_SECONDS",
    "SHOPGATE_KLINE_CACHE_TTL_SECONDS",
    "SHOPGATE_MARKET_ADMIN_TOKEN",
    "SHOPGATE_MARKET_CACHE_DIR",
    "SHOPGATE_MARKET_CACHE_ENABLED",
    "SHOPGATE_MARKET_HOST",
    "SHOPGATE_MARKET_PORT",
    "SHOPGATE_MARKET_RELOAD",
    "SHOPGATE_QUOTE_CACHE_TTL_SECONDS",
    "SHOPGATE_REDIS_CACHE_ENABLED",
    "SHOPGATE_REDIS_REQUIRED",
    "SHOPGATE_SCREENER_CACHE_TTL_SECONDS",
    "SHOPGATE_SYMBOL_CACHE_TTL_SECONDS",
    "REDIS_NAMESPACE",
    "REDIS_URL",
...
def main() -> None:
    ...
    port = int(os.getenv("SHOPGATE_MARKET_PORT", "8000"))
    uvicorn.run(
        "shopgate_commerce_data.api:app",
        host=host,
        port=port,
        reload=os.getenv("SHOPGATE_MARKET_RELOAD", "0") == "1",
    )
