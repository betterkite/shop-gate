...
function customerHref(datasetId: string, page: number): string {
  const query = new URLSearchParams({
    view: 'customers',
    dataset_id: datasetId,
    page: String(page),
...
function elasticityHref(datasetId: string, page: number): string {
  const query = new URLSearchParams({
    view: 'elasticity',
    dataset_id: datasetId,
    page: String(page),
...
function ElasticitySummary({ payload, datasetId }: { payload: JsonRecord | null; datasetId: string }) {
