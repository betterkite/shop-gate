...
export default async function AnalyticsWorkbenchPage({ searchParams }: Props) {
  ...
  const inventoryPage = Number.isFinite(requestedInventoryPage) && requestedInventoryPage > 0 ? requestedInventoryPage : 1;
