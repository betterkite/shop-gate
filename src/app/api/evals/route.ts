  ...
  try {
    ...
    if (action === 'create-case') {
      const item = await createCommerceEvalCase({
        ...
        expectedEntities: Array.isArray(body.expectedEntities) ? body.expectedEntities.map(String) : undefined,
        expectedEntityType: typeof body.expectedEntityType === 'string' ? body.expectedEntityType : undefined,
