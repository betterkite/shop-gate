...
export const RETAIL_VISUALIZATION_TEMPLATES: readonly RetailVisualizationTemplate[] = [
  ...
  },
  {
    ...
    dataSignals: ['gmv', 'buy_conversion', 'avg_price', 'concentration'],
  ...
  },
  {
    ...
    dataSignals: ['totals', 'day_over_day', 'avg_price', 'buy_conversion'],
    painPoints: ['9 天窗口不支持长期趋势推断'],
    finalDataContract: ['window', 'plannedEntities', 'datasets.summary'],
  },
];
