...
export const RETAIL_VISUALIZATION_TEMPLATES: readonly RetailVisualizationTemplate[] = [
  ...
  },
  {
    ...
    panels: ['hero-panel', 'insight-strip:kpis', 'chart-zone:daily', 'chart-zone:lifecycle', 'chart-zone:retention', 'chart-zone:profit', 'chart-zone:inventory', 'chart-zone:replenishment', 'action-strip', 'data-quality-footer'],
    firstViewport: ['hero-panel', 'insight-strip:kpis', 'chart-zone:daily'],
    variantGuidance: ['扩展分析接口返回的用户、渠道、成本和库存字段必须保留合成边界。', '商品阶段只解释窗口内购买活跃度，不得表述为真实上下架生命周期。', '价格弹性数据不足时展示缺口，不生成伪造系数。', '补货参考必须展示供货周期、目标覆盖天数和计算公式，不得写成立即采购指令。'],
