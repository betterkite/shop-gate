...
export function normalizeArtifacts(result: JsonRecord): CommerceEvalArtifactSummary {
  ...
  return {
    ...
    trendRows: numberValue(finalData.trendRows),
    profitRows: numberValue(finalData.profitRows),
    briefRows: numberValue(finalData.briefRows),
    orderRows: numberValue(finalData.orderRows),
    itemCount: numberValue(finalData.itemCount),
    inventoryItemCount: numberValue(finalData.inventoryItemCount),
